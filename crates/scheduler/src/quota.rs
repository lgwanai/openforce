...
pub struct QuotaLimits { pub max_concurrent_sessions: u32, pub max_running_workers: u32 }
#[derive(Debug, Clone, Default)] #[allow(dead_code)]
pub struct QuotaUsage { pub active_sessions: u32, pub running_workers: u32 }
#[allow(dead_code)]
